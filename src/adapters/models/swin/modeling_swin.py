...
from transformers.models.swin.modeling_swin import SwinSelfAttention, SwinOutput, SwinLayer

from .mixin_swin import SwinLayerAdaptersMixin, SwinOutputAdaptersMixin, SwinSelfAttentionAdaptersMixin


class SwinSelfAttentionWithAdapters(SwinSelfAttentionAdaptersMixin, SwinSelfAttention):
    def forward(
...
class SwinOutputWithAdapters(SwinOutputAdaptersMixin, SwinOutput):
...
class SwinLayerWithAdapters(SwinLayerAdaptersMixin, SwinLayer):
    ...
    def forward(
        ...
        self_attention_outputs = self.attention(
            self.layernorm_before(hidden_states),  # in Swin, layernorm is applied before self-attention
            head_mask,
        ...
        # in Swin, layernorm is also applied after self-attention
