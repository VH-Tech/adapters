...
class SwinSelfAttentionAdaptersMixin:
...
class SwinIntermediateAdaptersMixin:
    def init_adapters(self, model_config, adapters_config):
        # Wrap layers for LoRA
        self.dense = LoRALinear.wrap(self.dense, "intermediate", model_config, adapters_config)


class SwinOutputAdaptersMixin:
    """Adds adapters to the SwinOutput module."""
...
class SwinLayerAdaptersMixin:
    """Adds adapters to the SwinSelfOutput module."""
...
class SwinModelAdaptersMixin(ModelBaseAdaptersMixin):
    """Adds adapters to the SwinModel class."""
